                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="alert alert-danger">
                            <h5>You are eilgible to review this product</h5>
                            <p>
                                For the trusthworthiness of the revies, only customers who purchased the product can write a review about the product.
                            </p>
